...
// TODO: Declare atomic counter
// Hint: atomic_int atomic_counter = 0;
...
void* atomic_increment(void* arg) {
    for (int i = 0; i < INCREMENTS; i++) {
        // TODO: Use atomic_fetch_add to increment atomically
        // Hint: atomic_fetch_add(&atomic_counter, 1);
    }
    return NULL;
}
...
int main() {
    ...
    // TODO: Test atomic version
    // Reset atomic_counter to 0
    ...
    printf("\nTODO: Implement atomic version to see the speedup!\n");
